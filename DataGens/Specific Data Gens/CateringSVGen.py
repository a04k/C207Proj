...
def genPerson():
    ...
    person = {
        ...
        'birthdate': datetime.date(random.randint(1980, 1990), random.randint(1, 12), random.randint(1, 28)),
        'gender': gender
    }
    return person

personData = [genPerson() for _ in range(9)]

employeeData = [{'SSN': person['SSN'], 'Salary':random.choice([80000,85000])} for person in personData]
...
with open('Cat-SVData.txt', 'w') as file:
